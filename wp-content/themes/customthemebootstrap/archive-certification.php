        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-6">
                <div class="cat-header-text small text-center">
                    <h1 class="fs-5 fw-600">Certification Courses</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem eius blanditiis quibusdam nostrum? Neque laborum non nisi odit explicabo quis cumque cum dolore, eos blanditiis consectetur quo odio molestiae vel.</p>
